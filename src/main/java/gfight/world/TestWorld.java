...
public class TestWorld implements World {
    ...
    public void instantiate() {
        ...
        this.elements = List.<GraphicsComponent>of(
            new ShapeGraphicsComponent(EngineColor.BLUE, new Pair(250, 250), ShapeGraphicsComponent.ShapeType.CIRCLE, 40, 40),
            new ShapeGraphicsComponent(EngineColor.RED, new Pair(100, 100), ShapeGraphicsComponent.ShapeType.RECTANGLE, 100, 100),
            new TextGraphicsComponent(EngineColor.BLACK, new Pair(40, 60), "Banco di prova")
        );
        counterGraph = new TextGraphicsComponent(EngineColor.YELLOW,  new Pair(300, 300), String.valueOf(counter));
    }
